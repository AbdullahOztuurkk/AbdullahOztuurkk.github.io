...
Temsilcilerin .NET 'te birçok kullanımı vardır. Olaylar bağlamında, bir temsilci olay kaynağı ve olayı işleyen kod arasında bir ara (veya işaretçi benzeri mekanizmadır). Bir temsilciyi, önceki bölümdeki örnekte gösterildiği gibi, olay bildirimine ekleyerek bir olayla ilişkilendirirsiniz. Temsilciler hakkında daha fazla bilgi için, Delegate sınıfına bakın.
