...
permalink: yazilima-nereden-baslamaliyim
date:   2020-10-5
categories: kariyer
---
Merhaba arkadaşlar,
...
**_Algoritma_** : Belirli bir işin doğru bir şekilde gerçekleşmesi için yapılması gereken adım sırası olarak tanımlayabiliriz.
...
![](https://miro.medium.com/max/878/0*McYK75adGaqbzeOM)
...
**Hybrid:** Native uygulamalardan en temel farkı bir işletim sistemine bağlı kalmaması. Bir uygulama geliştirdiğinizde hem IOS hem Android sürümünü çıkarabiliyorsunuz. Aşağıda bahsedilen teknolojiler hakkındaki kaynakları inceleyebilirsiniz.
